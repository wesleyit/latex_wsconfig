...
\setlength{\parindent}{1.30cm}  % Indent size
...
% Insert puctures, make drawings and plots:
\usepackage{graphicx}
\usepackage{tikz}
\usepackage{pgfplots}
...
% Use and create colors definitions:
\usepackage{xcolor}

% This will define colors that can be used as a theme:
\definecolor{fgcolor}{HTML}{112233}
...
\usepackage{microtype}  % For better text alinment
...
% For this configuration the package BibLatex (with Biber backend)
...
% =====================================================================
% This section configures the abnlatex2 package. It is valid only
% when the documentclass is {abntex2}.
...
% Enable Fancy Headers (requires aditional configuration),
...
\usepackage{array}  % Provides tabulars that can split across pages
